...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/articles/create' => [[['_route' => 'create_article', '_controller' => 'App\\Controller\\ArticleController::create'], null, null, null, false, false, null]],
        '/articles' => [[['_route' => 'articles', '_controller' => 'App\\Controller\\ArticleController::list'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        25 => [[['_route' => 'article', '_controller' => 'App\\Controller\\ArticleController::show'], ['id'], null, null, false, true, null]],
